...
#MENU GRAVIMETRI
    ...
    with tab4:
        ...
        if st.button("Hitung Kadar", key = "T4"):
            ...
            st.success(f"% Kadar Besi = ({faktor_gravi}) x ({bobot_analit:.4f} / {bobot_sampel:.4f}) x 100% = {kadar_analit:.2f}%")
        ...
        with tab11:
            ...
            with tabB:
                ...
                if st.button("Hitung Kadar", key = "TB"):
                    ...
                    st.success(f"% Kadar Persen = (((2({b:.2f} - {a:.2f})) x {Normalitas:.4f} x {berat_ekivalen}) / {volume_sampel:.2f}) x {fk} x {fp} x 100%")
